...
namespace kernel
{
class ElapTimerKernel : public NativeGpuKernelMod 
{
    public:
      ElapTimerKernel();
      ~ElapTimerKernel();
    ...
    //MS_REG_GPU_KERNEL(ElapTimer,
    //        KernelAttr().AddInputAttr(kNumberTypeInt32).AddOutputAttr(kNumberTypeFloat32), ElapTimerKernel, float)
